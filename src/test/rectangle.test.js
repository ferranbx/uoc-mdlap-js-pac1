...
describe('RECTANGLE TESTS', () => {
    test('When nothing is given, then should return error', () => {
        expect(rectangleArea()).toEqual(Error('Not a rectangle'));
    })
    ...
    test('When a triangle is given, then should return error', () => {
        expect(rectangleArea(["(0 0)","(1 1)","(0 2)"])).toEqual(Error('Not a rectangle'));
    })
    test('When a pentagon is given, then should return error', () => {
        expect(rectangleArea(["(1 0)","(1 1)","(2 2)","(4 1)","(2 1)"])).toEqual(Error('Not a rectangle'));
    })
    ...
    test('When a simple square is given, then should return false', () => {
        expect(rectangleArea(["(0 0)","(0 1)","(1 1)","(1 0)"])).toEqual(1);
    })
    test('When a simple rectangle is given, then should return false', () => {
        expect(rectangleArea(["(1 1)","(1 3)","(3 1)","(3 3)"])).toEqual(4);
    })
    test('When a complex rectangle is given, then should return false', () => {
